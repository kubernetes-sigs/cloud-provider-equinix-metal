...
func TestEmptyGetLoadBalancer(t *testing.T) {
	k8sclient := fake.NewSimpleClientset()
	lb := NewLB(k8sclient, "test-config")
...
func TestEmptyAddService(t *testing.T) {
	k8sclient := fake.NewSimpleClientset()
	lb := NewLB(k8sclient, "test-config")
...
func TestEmptyRemoveService(t *testing.T) {
	k8sclient := fake.NewSimpleClientset()
	lb := NewLB(k8sclient, "test-config")
...
func TestEmptyUpdateService(t *testing.T) {
	k8sclient := fake.NewSimpleClientset()
	lb := NewLB(k8sclient, "test-config")
